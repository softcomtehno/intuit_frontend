  ...
  return (
    <Link to={`/specialization/${url}`}>
      <Card
        ...
        className="w-[400px] max-h-[270px] h-[270px] flex flex-col justify-between bg-[#f7f9fd] p-5 hover:bg-green transition-all prof-card border-[#cfd3d8] rounded-xl cursor-pointer sm:w-[350px] sm:h-[300px]"
      >
