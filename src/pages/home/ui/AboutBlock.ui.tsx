  ...
  return (
    <div>
      ...
      <div className="flex justify-between md:flex-col-reverse">
        <div className="max-w-[47%] bg-[#ecedf0] p-5 rounded-xl">
        ...
        <div className='p-3 bg-[#ecedf0] w-[50%] rounded-lg flex justify-center'>
        <iframe className='w-[95%] h-full rounded'  src="https://www.youtube.com/embed/diIcqVN1Dag?si=0HPGrFl0BrTQEhn0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
      </div>
      <Stats/>
    </div>
