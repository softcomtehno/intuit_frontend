...
export const EventPage = () => {
  ...
  if (isError || !data) return <Alert severity="error">Ошибка загрузки события</Alert>;
  ...
  return (
    <div className="max-w-3xl mx-auto p-5">
      <Card className="p-5 shadow-lg rounded-lg">
        <div className="relative w-full h-60 bg-cover bg-center rounded-lg" style={{ backgroundImage: `url(${data.data.banner})` }}>
