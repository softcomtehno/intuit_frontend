...
import { Typography, Container, Grid, Box, List, ListItem, ListItemText } from '@mui/material';
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          <Box>
            ...
            <Typography variant="body1" gutterBottom>
              В МУИТ можно поступить на бюджетные места, финансируемые из бюджета МУИТ (если ОРТ свыше 200 баллов или золотой сертификат), и на контрактную основу обучения.
            </Typography>
            <Typography variant="body1">
              Льготы по оплате предоставляются инвалидам I и II групп, детям-сиротам и детям, находящимся под опекой. Размер и период предоставления льгот устанавливается комиссией МУИТ.
            </Typography>
          </Box>
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Box>
            ...
            <Typography variant="body1" gutterBottom>
              Электронная регистрация осуществляется исключительно в дистанционном формате на порталах:
            </Typography>
            <List>
              <ListItem>
        ...
        <Grid item xs={12}>
          <Box>
            ...
            <Typography variant="body1">
              • Справка № 086-У не требуется.<br />
              • МУИТ не имеет общежитий.<br />
              • Полный перечень специальностей доступен в буклете МУИТ.
            </Typography>
          </Box>
        </Grid>
      </Grid>
