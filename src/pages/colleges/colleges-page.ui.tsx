  ...
  return (
    <Container maxWidth="lg" className="py-10 px-4">
      ...
      >
        ...
        чтобы получить среднее профессиональное образование. Колледжи предлагают
        практические и теоретические знания, которые помогают готовить
        специалистов в различных областях. Это отличный выбор для тех, кто хочет
        начать карьеру или продолжить обучение в вузе.
      </Typography>
          ...
          <Card className="flex flex-col sm:flex-row mb-4 border border-gray shadow-none hover:shadow-lg p-4 w-full max-w-lg items-center">
            ...
            <CardContent>
              ...
              <Typography
                ...
                className="mb-2"
              >
                Колледж предлагает направления по программированию, менеджменту,
                дизайну, и другим востребованным профессиям.
              </Typography>
              <Typography
                variant="body2"
                color="textSecondary"
      ...
      >
        ...
        востребованных областях, таких как IT, управление, экономика, и дизайн.
        Вы можете развивать свои навыки и получить профессию, которая будет
