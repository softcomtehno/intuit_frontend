      ...
      >
        ...
        >
          <SwiperSlide>
            ...
            >
              <Card className="transition duration-75 max-w-[500px] max-h-[230px] bg-[#f5f5f5] p-7 flex shadow-none rounded-lg  hover:cursor-pointer md:flex-col md:max-h-full md:gap-10 items-center">
                <div className="flex flex-col justify-between">
                  ...
                  <Button className="self-start shadow-none bg-blue text-white p-1 rounded px-4 font-medium">
                    Посмотреть
                  </Button>
                </div>
                <img
