    ...
    <footer className="bg-[#0d1140] text-white py-5 ">
      ...
      <div className=" max-w-[80%] mx-auto lg:hidden">
        ...
        <div className="flex justify-between mt-6">
          ...
          <ul>
            <h5 className="font-bold mt-5">{t("footer.fields.workSchedule")}</h5>
            <li>
          ...
          <div>
            <h5 className="font-bold mt-5">{t("footer.fields.forAllQuestions")}</h5>
            <Button
            ...
            <h5 className="font-bold mt-5">{t("footer.fields.admissionsOffice")}</h5>
            <Button
              className="text-white"
              startIcon={<LocalPhoneRoundedIcon />}
            >
